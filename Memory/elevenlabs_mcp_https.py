"""
ElevenLabs MCP Server with HTTPS Support
=========================================
Run this server with SSL certificates for HTTPS
"""
...
def home():
    return jsonify({
        "service": "Memory Bot MCP Server (HTTPS)",
        "status": "running",
...
if __name__ == '__main__':
    print("=" * 60)
    print("MEMORY BOT MCP SERVER FOR ELEVENLABS (HTTPS)")
    print("=" * 60)
    print(f"MD Files indexed: {len(MD_FILES)}")
    print("\nTo use with ElevenLabs:")
    print("1. Deploy this to a service with HTTPS (Replit, Render, etc.)")
    print("2. Or use ngrok for local HTTPS tunnel")
    print("3. Use the HTTPS URL in ElevenLabs dashboard")
    print("=" * 60)

    # For local development without HTTPS
    print("\nStarting HTTP server on port 3000...")
    print("Note: ElevenLabs requires HTTPS. Use ngrok or deploy to cloud.")
