    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="bg-green-500 text-white p-4 flex items-center justify-between shadow-lg">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="font-semibold">Memory Assistant</h1>
            <p className="text-xs text-green-100">Your AI Memory Companion</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Start a conversation with your Memory Assistant!</p>
          </div>
        ) : (
